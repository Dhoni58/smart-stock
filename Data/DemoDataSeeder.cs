...
{
    public static async Task SeedBusinessDataAsync(AppDbContext db)
    {
    ...
    public static async Task ResetBusinessDataAsync(AppDbContext db)
    {
        db.InvoiceItems.RemoveRange(db.InvoiceItems);
        db.Invoices.RemoveRange(db.Invoices);
        db.WarehouseMovements.RemoveRange(db.WarehouseMovements);
